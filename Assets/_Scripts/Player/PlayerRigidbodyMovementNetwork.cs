...
public class PlayerRigidbodyMovementNetwork : NetworkBehaviour
{
    ...
    {
        var targetVelocity = inputDirection * Speed * Time.fixedDeltaTime;
        ...
        {
            Quaternion toRotation = Quaternion.LookRotation(new Vector3(inputDirection.x, 0, inputDirection.z), Vector3.up);
